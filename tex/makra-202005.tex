...
\vskip 1.7cm
\noindent{\it Hospodin stráži dych človeka, skúma všetky zákutia vnútra. \hfill Prísl 20,~27}%
}}
...
redakcia: D. Jones, P. Kolárovský, obálka: M. Kohút, sadzba: I. Kohút\crl
}}
\vfil\break
}
...
\def\koniecprogramu{{\typosize[9/12]\it%
\noindent\centerline{Až do odvolania budú bohoslužby prebiehať v nasledovnom režime:}

\noindent\centerline{Bohoslužby o 9.00 hod. sú prednostne pre osoby staršie ako 65 rokov.}

\noindent\centerline{Živý prenos bude zabezpečený zo zhromaždenia o 11.00 hod.}
